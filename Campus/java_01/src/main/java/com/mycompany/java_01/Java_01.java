...
public class Java_01 {
    ...
    public static void main(String[] args) {
        /* 
            Se requiere calcular las horas extras devengadas por 1 empleado, en un rango de meses, tomar en cuenta lo siguiente, si el empleado gana mas de 2 SMLV cada hora extra que se encuentre en la primera quincena y, no sea fin de semana se paga al 1% del salario devengado, si es fin de semana al 2% si en caso dado es la segunda semana, se pagan por igual fines de semanas o no a 3%. Si en caso dado el empleado gana menos de 2 SMLV, entonces infomarles que aun no esta disponible dicho modulo para su estirpe.
        */
